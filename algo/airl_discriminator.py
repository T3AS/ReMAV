...
class Discriminator(Base):
    def __init__(self, save_path, obs_dims, n_actions, lr=1e-4):
        ...
        with tf.variable_scope('discriminator'):
            ...
            self.state = tf.placeholder(dtype=tf.float32, shape=[None, *obs_dims], name='state')
        ...
        self.rewards = tf.math.subtract(tf.log(self.prob), tf.log(1-self.prob), name='rewards')
    ...
    def construct_network(self, input):
        ...
        layer_2 = tf.layers.dense(inputs=layer_1, units=50, activation=tf.nn.leaky_relu, name='layer2')
    ...
    def get_rewards(self, agent_s, agent_a):
        ...
        # print("state shape: ", agent_s, "action shape: ", agent_a )
