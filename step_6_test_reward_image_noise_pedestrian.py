...
#def eval(epo):
r_his = []
with open("IRL_protest_result_imagenoise_pedestrian.json", "a")  as f2, open("info_car2.json", "a") as car2, open("info_pedestrian1.json", "a") as pedestrian1:
    ...
    for i in range(20): #(5 epo):
        ...
        while i<1500: #1000 #while not done:
            ...
            next_obs, reward, done, info = env.step(action_dict={'car2': action['car2'], 'pedestrian1': action['pedestrian1']})#,noise=False)
