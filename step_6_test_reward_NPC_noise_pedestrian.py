...
parser.add_argument(
    ...
    default='/home/aizaz/ray_results/Pedestrian/MA-Inde-PPO-SSUI3CCARLA/PO_HeteNcomIndePOIntrxMATLS1B2C1PTWN3-v0_0_2023-04-21_15-34-430cgz9bmk/checkpoint_100/checkpoint-100',
...
#def eval(epo):
r_his = []
with open("IRL_protest_result_NPCnoise_pedestrian.json", "a")  as f2, open("info_car2.json", "a") as car2, open("info_pedestrian1.json", "a") as pedestrian1:
    ...
    for i in range(20): #(5 epo):
        ...
        while i<1500: #1000 #while not done:
            ...
            next_obs, reward, done, info = env.step({'car2': action['car2'], 'pedestrian1': action['pedestrian1']}, noise)
