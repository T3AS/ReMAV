...
#def eval(epo):
r_his = []
with open("IRL_protest_result_NPCnoise_three_way.json", "a")  as f2,open("info_car1.json", "a") as car1, open("info_car2.json", "a") as car2, open("info_car3.json", "a") as car3:
    ...
    for i in range(20): #(5 epo):
        ...
        while i<1500: #1000 #while not done:
            ...
            next_obs, reward, done, info = env.step({'car1': action['car1'], 'car2': action['car2'], 'car3': action['car3']}, noise)
